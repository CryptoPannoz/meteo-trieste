(function () {
  ...
  window.stationChartHtml = function (rows, color, lang) {
    ...
    return '<div class="wind-chart"><div class="chart-tip" role="status"></div><svg viewBox="0 0 '+w+' '+h+'" role="img"><defs><linearGradient id="'+id+'" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="'+color+'" stop-opacity=".24"/><stop offset="1" stop-color="'+color+'" stop-opacity=".03"/></linearGradient></defs>'+levels+'<text x="8" y="13" font-size="10" fill="#98a4ad">kt</text><polygon fill="url(#'+id+')" points="'+area+'"/><polyline fill="none" stroke="#74808a" stroke-width="2.5" stroke-dasharray="6 4" stroke-linejoin="round" points="'+points("gust")+'"/><polyline fill="none" stroke="'+color+'" stroke-width="3.5" stroke-linejoin="round" stroke-linecap="round" points="'+points("kt")+'"/>'+axis+'<g class="chart-cursore" visibility="hidden"><line y1="'+sy+'" y2="'+base+'" stroke="#f0f43c" opacity=".45"/><circle r="5" fill="#0b1014" stroke="'+color+'" stroke-width="3"/></g>'+hits+'</svg><div class="chart-legend"><span class="key" style="--c:'+color+'">'+labels.wind+'</span><span class="key" style="--c:#74808a">'+labels.gust+'</span><span>'+labels.direction+'</span></div></div>';
  };
