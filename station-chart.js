(function () {
  ...
  window.stationChartHtml = function (rows, color, lang) {
    ...
    var axis=data.map(function(r,i){var deg=degrees[String(r.dir).toUpperCase().trim()];var arrow=deg==null?"":'<text x="0" y="0" text-anchor="middle" font-size="16" font-weight="800" fill="#243142" transform="rotate('+deg+')">↓</text>';return '<g transform="translate('+x(i)+',176)">'+arrow+'<text x="0" y="18" text-anchor="middle" font-size="10" font-weight="700" fill="#243142">'+esc(r.dir)+'</text><text x="0" y="36" text-anchor="middle" font-size="11" fill="#66717c">'+esc(r.time)+'</text></g>';}).join("");
    ...
    var labels=lang==="sl"?{wind:"veter",gust:"sunek",direction:"smer"}:{wind:"vento",gust:"raffica",direction:"direzione"};
